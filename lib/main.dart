...
import 'features/products/home/model/repositories/category_repository.dart';
import 'features/products/home/model/repositories/products_repositories.dart';
import 'features/products/home/view_model/category/category_cubit.dart';
import 'features/products/home/view_model/product/product_cubit.dart';
  ...
  if (message.notification != null) {
    ...
    AwesomeNotifications().createNotification(
      content: NotificationContent(
        ...
        channelKey: 'high_importance_channel', // Ensure this matches the initialized channelKey
...
Future<void> main() async {
  ...
  MyFirebaseMessagingService firebaseMessagingService = MyFirebaseMessagingService();
  ...
  FirebaseMessaging.onMessage.listen((RemoteMessage message) {
    ...
    if (message.notification != null) {
      ...
      AwesomeNotifications().createNotification(
        content: NotificationContent(
          id: 100897654, // Unique ID for this notification
          channelKey: 'basic_channel', // Ensure this matches the initialized channelKey
          title: message.notification?.title,
          body: message.notification?.body,
          notificationLayout: NotificationLayout.Default,
        ),
  ...
  // Initialize cubits
  final CategoryCubit categoryCubit = CategoryCubit(CategoryRepository(FirebaseFirestore.instance));
  final ProductCubit productCubit = ProductCubit(ProductRepository(FirebaseFirestore.instance));
  runApp(
    MultiBlocProvider(
      providers: [
        ...
        BlocProvider(create: (context) => HomeCubit(categoryCubit: categoryCubit, productCubit: productCubit),)
      ],
